...
const testThemes = [
  { id: 'unit-1', title: 'Einheit 1', subtitle: 'Leseverstehen', theme: 'Alltag', answers: { p1: ['Richtig', 'Falsch', 'Richtig', 'Falsch', 'Falsch', 'Richtig'], p2: ['b', 'a', 'a', 'b', 'a', 'c'], p3: ['G', 'H', 'B', 'A', 'O', 'D', 'J'], p4: ['Nein', 'Ja', 'Nein', 'Nein', 'Ja', 'Ja', 'Nein'], p5: ['c', 'c', 'c', 'c'] } },
  { id: 'unit-2', title: 'Einheit 2', subtitle: 'Beruf und Alltag', theme: 'Beruf', answers: { p1: ['Falsch', 'Richtig', 'Richtig', 'Falsch', 'Richtig', 'Falsch'], p2: ['b', 'b', 'c', 'a', 'c', 'a'], p3: ['G', 'I', 'J', 'E', 'B', 'O', 'H'], p4: ['Ja', 'Nein', 'Nein', 'Ja', 'Nein', 'Nein', 'Ja'], p5: ['c', 'a', 'a', 'a'] } },
  { id: 'unit-3', title: 'Einheit 3', subtitle: 'Freizeit und Reisen', theme: 'Reisen', answers: { p1: ['Richtig', 'Falsch', 'Falsch', 'Falsch', 'Richtig', 'Richtig'], p2: ['a', 'c', 'c', 'a', 'c', 'a'], p3: ['I', 'B', 'D', 'A', 'E', 'O', 'F'], p4: ['Nein', 'Ja', 'Nein', 'Nein', 'Ja', 'Ja', 'Ja'], p5: ['a', 'c', 'b', 'a'] } },
  { id: 'unit-4', title: 'Einheit 4', subtitle: 'Familie und Beziehungen', theme: 'Familie', answers: { p1: ['Falsch', 'Richtig', 'Richtig', 'Falsch', 'Richtig', 'Falsch'], p2: ['b', 'a', 'a', 'b', 'c', 'c'], p3: ['B', 'H', 'D', 'I', 'O', 'J', 'E'], p4: ['Nein', 'Nein', 'Ja', 'Ja', 'Nein', 'Nein', 'Nein'], p5: ['a', 'b', 'b', 'c'] } },
  { id: 'unit-5', title: 'Einheit 5', subtitle: 'Gesundheit und Wohlbefinden', theme: 'Gesundheit', answers: { p1: ['Richtig', 'Falsch', 'Richtig', 'Falsch', 'Falsch', 'Falsch'], p2: ['c', 'c', 'b', 'b', 'a', 'b'], p3: ['J', 'G', 'A', 'O', 'E', 'B', 'H'], p4: ['Nein', 'Nein', 'Ja', 'Nein', 'Ja', 'Ja', 'Nein'], p5: ['b', 'a', 'c', 'b'] } },
  { id: 'unit-6', title: 'Einheit 6', subtitle: 'Stadt und Mobilität', theme: 'Stadt', answers: { p1: ['Richtig', 'Richtig', 'Falsch', 'Falsch', 'Richtig', 'Falsch'], p2: ['a', 'b', 'b', 'a', 'c', 'b'], p3: ['B', 'F', 'G', 'O', 'A', 'I', 'D'], p4: ['Nein', 'Nein', 'Ja', 'Nein', 'Ja', 'Ja', 'Nein'], p5: ['a', 'c', 'a', 'b'] } },
  { id: 'unit-7', title: 'Einheit 7', subtitle: 'Kultur und Medien', theme: 'Kultur', answers: { p1: ['Richtig', 'Richtig', 'Falsch', 'Falsch', 'Richtig', 'Falsch'], p2: ['c', 'b', 'a', 'b', 'b', 'c'], p3: ['I', 'B', 'A', 'D', 'O', 'F', 'H'], p4: ['Ja', 'Ja', 'Nein', 'Ja', 'Ja', 'Nein', 'Nein'], p5: ['c', 'a', 'c', 'b'] } },
  { id: 'unit-8', title: 'Einheit 8', subtitle: 'Essen und Einkaufen', theme: 'Essen', answers: { p1: ['Richtig', 'Richtig', 'Falsch', 'Falsch', 'Falsch', 'Falsch'], p2: ['b', 'c', 'b', 'c', 'c', 'b'], p3: ['B', 'O', 'J', 'H', 'D', 'C', 'G'], p4: ['Ja', 'Nein', 'Ja', 'Nein', 'Ja', 'Nein', 'Ja'], p5: ['b', 'a', 'b', 'c'] } },
  { id: 'unit-9', title: 'Einheit 9', subtitle: 'Sprachen und Lernen', theme: 'Lernen', answers: { p1: ['Richtig', 'Richtig', 'Falsch', 'Richtig', 'Falsch', 'Falsch'], p2: ['b', 'a', 'a', 'b', 'a', 'a'], p3: ['H', 'D', 'J', 'A', 'O', 'C', 'I'], p4: ['Nein', 'Nein', 'Nein', 'Ja', 'Ja', 'Nein', 'Nein'], p5: ['c', 'a', 'b', 'c'] } },
  { id: 'unit-10', title: 'Einheit 10', subtitle: 'Umwelt und Nachhaltigkeit', theme: 'Umwelt', answers: { p1: ['Richtig', 'Falsch', 'Richtig', 'Falsch', 'Richtig', 'Falsch'], p2: ['a', 'a', 'b', 'b', 'a', 'c'], p3: ['B', 'E', 'H', 'A', 'O', 'J', 'C'], p4: ['Ja', 'Nein', 'Nein', 'Ja', 'Ja', 'Nein', 'Ja'], p5: ['b', 'a', 'a', 'b'] } },
  { id: 'unit-11', title: 'Einheit 11', subtitle: 'Zukunft und Pläne', theme: 'Zukunft', answers: { p1: ['Richtig', 'Falsch', 'Richtig', 'Falsch', 'Falsch', 'Falsch'], p2: ['c', 'a', 'c', 'b', 'a', 'c'], p3: ['F', 'A', 'D', 'H', 'J', 'B', 'O'], p4: ['Ja', 'Nein', 'Nein', 'Ja', 'Ja', 'Ja', 'Nein'], p5: ['a', 'b', 'b', 'c'] } },
  { id: 'unit-12', title: 'Einheit 12', subtitle: 'Medien und Alltag', theme: 'Medien', answers: { p1: ['Richtig', 'Richtig', 'Falsch', 'Falsch', 'Falsch', 'Richtig'], p2: ['c', 'c', 'b', 'a', 'b', 'b'], p3: ['O', 'I', 'D', 'F', 'C', 'G', 'A'], p4: ['Ja', 'Nein', 'Ja', 'Ja', 'Nein', 'Ja', 'Ja'], p5: ['c', 'b', 'a', 'b'] } },
  { id: 'unit-13', title: 'Einheit 13', subtitle: 'Sprache und Wortschatz', theme: 'Sprache', answers: { p1: ['Richtig', 'Falsch', 'Richtig', 'Falsch', 'Falsch', 'Richtig'], p2: ['c', 'a', 'b', 'c', 'c', 'a'], p3: ['E', 'O', 'B', 'D', 'A', 'G', 'I'], p4: ['Ja', 'Nein', 'Ja', 'Ja', 'Nein', 'Ja', 'Nein'], p5: ['a', 'b', 'c', 'c'] } },
  { id: 'unit-14', title: 'Einheit 14', subtitle: 'Texte und Informationen', theme: 'Texte', answers: { p1: ['Richtig', 'Falsch', 'Richtig', 'Richtig', 'Richtig', 'Falsch'], p2: ['c', 'b', 'c', 'a', 'c', 'b'], p3: ['G', 'B', 'J', 'O', 'F', 'C', 'A'], p4: ['Nein', 'Nein', 'Ja', 'Ja', 'Ja', 'Ja', 'Nein'], p5: ['b', 'b', 'b', 'b'] } },
  { id: 'unit-15', title: 'Einheit 15', subtitle: 'Zusammenfassung und Prüfung', theme: 'Prüfung', answers: { p1: ['Falsch', 'Falsch', 'Falsch', 'Richtig', 'Richtig', 'Richtig'], p2: ['c', 'a', 'a', 'b', 'b', 'a'], p3: ['O', 'D', 'F', 'G', 'A', 'J', 'C'], p4: ['Ja', 'Ja', 'Nein', 'Ja', 'Nein', 'Nein', 'Nein'], p5: ['c', 'b', 'b', 'a'] } }
];
